...
const steps = [
  { step: '01', title: 'Upload your document', description: 'Drag and drop any PDF contract or legal document into your workspace.' },
    ...
    <div className="min-h-screen bg-white dark:bg-zinc-950 transition-colors duration-300">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24 text-center">
        ...
        <p className="mt-6 text-lg text-zinc-600 dark:text-zinc-400 max-w-2xl mx-auto leading-relaxed">
          Upload contracts, agreements, and legal notices. Ask questions in plain English.
        ...
        {/* hero card */}
        <div className="mt-16 max-w-3xl mx-auto bg-zinc-950 dark:bg-zinc-900 rounded-2xl border border-zinc-800 p-6 text-left shadow-2xl">
              ...
              <div className="bg-zinc-800 border border-zinc-700 rounded-2xl rounded-tl-sm px-4 py-3 text-sm text-zinc-200 max-w-sm">
                ...
                <ul className="flex flex-col gap-1.5 text-zinc-300">
                  <li className="flex items-start gap-2">
                    ...
                    Unlimited liability clause in Section 6
                  </li>
                  <li className="flex items-start gap-2">
                    <AlertTriangle className="w-3.5 h-3.5 text-red-400 shrink-0 mt-0.5" />
                    3-year non-compete across 4 countries
                  </li>
                  <li className="flex items-start gap-2">
                    <AlertTriangle className="w-3.5 h-3.5 text-red-400 shrink-0 mt-0.5" />
                    3% monthly compounded late penalty
                  </li>
                </ul>
              </div>
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, i) => (
            <div
              key={i}
              className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 hover:border-zinc-300 dark:hover:border-zinc-700 hover:shadow-md transition-all duration-200"
            >
              <div className="w-9 h-9 bg-blue-50 dark:bg-blue-900/20 rounded-xl flex items-center justify-center mb-4">
          ...
          <div className="relative">
            ...
            <div className="flex items-center justify-center gap-3 flex-wrap">
              <button
                ...
                className="bg-white text-blue-600 hover:bg-blue-50 font-semibold text-sm px-6 py-3 rounded-xl transition-all duration-200 flex items-center gap-2"
              >
                Get started free
                <ArrowRight className="w-4 h-4" />
              </button>
            ...
            <div className="flex items-center justify-center gap-6 mt-6 flex-wrap">
              {['No credit card', 'Upload in 60 seconds', 'Cancel anytime'].map((item) => (
